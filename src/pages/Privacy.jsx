const PrivacyPolicy = () => {
  return (
      ...
      1.4. Please note that some privacy rights and obligations may differ in certain locations based on local law, in which case XFinitive will comply with the local legal requirements. If you are a California resident, our Privacy Notice for California Residents in Section 18 may apply to you. XFinitive reserves the right, at any time, to modify this Privacy Policy. If we make revisions that change the way we collect, use, or share Personal Information, we will post those changes in this Privacy Policy. If we make material changes to our Privacy Policy, we may also notify you by other means prior to the changes taking effect, such as by posting a notice on our Site or sending you a notification. You should review this Privacy Policy periodically so that you keep up to date on our most current policies and practices. XFinitive will note the effective date of the latest version of our Privacy Policy at the beginning of this Privacy Policy.
    
    
      1.5. Employees and job applicants who are California residents receive a supplemental privacy notice that applies to their relationship with XFinitive in the context of their employment or job application. In the event of any conflict with this Privacy Policy, the terms of the supplementary employee notice will control.
      ...
      3.1. XFinitive uses information collected from users of the Services to personalize and improve your visit and experience, to provide the Services to you or our customers, and for other purposes set out below. When you use the Services, XFinitive may collect Personal Information in the following ways described below.
    
    
      3.2 Information You Provide to XFinitive: XFinitive collects Personal Information when you use and interact with the Services, such as when you:
    
    
      3.2.1. Communicate with XFinitive about our Services whether by letter, e-mail, online chat window, or telephone;
    
    
      3.2.2. Complete and submit forms to us on our Sites or Provider Portals (e.g., to register for an account on a Provider Portal, 
      authenticate yourself to verify your authorized use of the Services, to register for our events, or to subscribe to our newsletters);
      ...
      4.1.1 This Privacy Policy supplements the Customer Documents. XFinitive only uses such PHI as a “business associate” of its Providers, who are “covered entities,” in accordance with any instructions or restrictions provided to XFinitive by the Provider and in full compliance with the applicable provisions of HIPAA.
      ...
      4.1.3 Our Sites are generally not intended to collect or retain any PHI. Thus, sections of this Privacy Policy that discuss Personal Information collection on the Sites do not apply to PHI, and we do not request, obtain, use or disclose any PHI through our Sites such as www.XFinitive.com.
    
    
      5. Use of Information Collected By XFinitive :
    
    
      5.1 XFinitive uses the Personal Information collected
       to provide Services to our customers and their authorized users to improve user experience with the Services, and to communicate with you about requested information. XFinitive may use Personal Information to help target specific offers to customers and others and to develop and improve its Services.
      Additionally, XFinitive may disclose your Personal Information as discussed below in Section 7, and use your Personal Information to:
      ...
      Conduct internal analytics for the purposes of development and improvement of the XFinitive app.
      ...
      6.1.1. Web Beacons: A Web Beacon is a Web page element (such as a clear gif, pixel tag or single-pixel gif) that may be embedded into our Sites or e-mail communications, and which may employ cookie technology to enable XFinitive to record clickstream data.
    
    
      6.1.2. Cookies: Cookies are small text files placed on your device to store data that can be recalled by a Web server in the domain that placed the cookie. Cookies enable XFinitive to collect clickstream data, including traffic on the Sites. You may set your browser to reject certain cookies or to notify you when you are sent a cookie. Rejecting cookies may limit functionality of the Sites. Third parties also provide software that allows you to visit the Sites without providing certain types of this information. Our Sites may use the following types of cookies:
      ...
      7.1.1. At Your Request: XFinitive may disclose Personal Information to third parties at your request, direction, or authorization. For example, if you direct XFinitive to disclose your Personal Information to a third-party entity, whether and XFinitive business partner or other third party to use the third party’s service, we will share your information with the third party.
      
      
      7.1.2. Internal Sharing: XFinitive may disclose Personal Information to its affiliates (including parents, entities under common ownership, and subsidiaries, such as XFinitive, LLC), and other related companies without authorization.
      
      
      7.1.3. With Our Service Providers: XFinitive may disclose Personal Information to service providers for the purposes of operating our business, delivering, improving, and customizing our products or services, sending marketing and communications related to our business, payment processing, and for other legitimate purposes permitted by applicable law.
      
      
      7.1.4. With Our Customers: XFinitive may disclose Personal Information, including Sensitive Personal Information, to its customers consistent with the Customer Documents. Sensitive Personal Information” refers to Personal Information regarding more sensitive areas, such as government ID and certain other financial information, gender, marriage status, race/ethnicity, or veteran or disability status.
      
      
      7.1.5. Compliance with Law: To the extent permitted by law, XFinitive will disclose Personal Information to government authorities or third parties pursuant to a legal request, subpoena, or other legal process. XFinitive may also use or disclose your Personal Information as permitted by law to perform charge verifications, apply, or enforce the Service’s Terms of Use or Terms and Conditions, or protect XFinitive’s rights, interests, or property as well as those of XFinitive affiliates, customers, or Service users.
      
      7.1.6. Business Transaction: If XFinitive sells all or part of its business or makes a sale or transfer of assets or is otherwise involved in a merger or business transfer, XFinitive may transfer your Personal Information to a third party as part of that transaction.8. Advertising and Third-Party Data Collection :
      
      Finitive may enter into relationships with third-party advertising companies to drive traffic to and serve ads on our Site. These third-party companies may also collect information through Data Collection Technologies described in Section 6 to measure the effectiveness of their ads and to personalize advertising content. The Network Advertising Initiative offers useful information about Internet advertising companies (also called “ad networks” or “network advertisers”), including information about how to opt-out of their information collection, here. We do not use such providers on our Portals.
      
      8.1. You may opt-out of receiving marketing communications from us by following the instructions included in such a communication or by contacting us as provided in the Contact Information Section 17. If you opt out, we may still send you non-marketing communications, such as those about your account or our ongoing business relationship.8.2. You may review and request changes to the Personal Information we have collected about you by contacting us as provided in the Contact Information Section 17 below.9. Biometric Data :In connection with the Services, XFinitive may collect or store biometric data, such as fingerprints or facial geometry scans that may identify you, which are uses for authentication and verification of your identity. This information may be biometric data under certain laws governing the collection, use, storage, and disclosure of biometric data. By providing such information, you acknowledge that you have been advised of, and understand that, XFinitive, and its agents and contractors, may collect, use, store, and disclose biometric data for the purposes described in this Privacy Policy, or as otherwise described in the Services. We will not sell, lease, or trade your biometric information. We will retain such biometric data only until the occurrence of the first of the following, at which point the data will be scheduled for deletion: (a) the purposes outlined in this Section 9 have been satisfied, (b) any date of deletion required by applicable law, or (c) three (3) years have passed since your last interaction with our Services. Notwithstanding the foregoing, (1) XFinitive will not delete biometric data that is PHI unless required by the applicable Provider, and (2) except as provided for in subsection (1), the collection, use, storage, disclosure, and retention of biometric data that is PHI through the use of any Service shall be governed by Section 4 of this Privacy Policy and any applicable Customer Documents, not this Section 9.10. Security of Personal Information :XFinitive has reasonable and appropriate safeguards in place to help protect the Personal Information XFinitive collects from loss, misuse, and unauthorized access, disclosure, alteration, and destruction. Although XFinitive attempts to protect the Personal Information in our possession, no security system is perfect, and XFinitive cannot promise that your Personal Information will remain absolutely secure in all circumstances.11. Retention of Personal Information :XFinitive will retain your Personal Information as needed to fulfill the purposes for which it was collected. XFinitive will retain and use your Personal Information as necessary to comply with XFinitive’s business requirements, legal obligations, resolve disputes, protect our assets, and enforce our agreements. Additional information for California residents about our data retention practices is available in our Privacy Notice for California Residents.12. Aggregated De-Identified Information :XFinitive may provide aggregated information related to your Personal Information to some of XFinitive’s business partners. This information is used in a collective manner and does not identify you individually in any way. If you are a patient of a Provider, we may only create, use or disclose aggregated or certain de-identified PHI as authorized by your Provider in the Customer Documents.13. Links to Third Party Websites :Our Sites may contain certain links to third party websites. XFinitive is not responsible or liable for the privacy practices or content found on these websites. You should check the privacy notice and policies of each website you visit. Links to third party websites are provided solely for your convenience and any use or submission of data to such websites shall be at your sole risk.14. Children’s Privacy :Our Sites are not directed toward individuals under the age of 18. We do not promote our Sites to individuals under 18, and we do not knowingly collect any Personal Information through our Sites from individuals under 18. Access to our Portals is separately governed by the Portals’ posted Terms of Use.15. United States Only :The Services are intended for use only in the United States of America. If you use the Services or contact us from outside of the United States of America, please be advised that (i) any information you provide to us or that we automatically collect will be transferred to the United States of America; and (ii) by using the Services or submitting information, you explicitly authorize its transfer to and subsequent processing in the United States of America in accordance with this Privacy Policy.16. Changes to the Privacy Policy :XFinitive may change this Privacy Policy at any time. Unless we say otherwise, changes will be effective upon the last updated date at the top of this Privacy Policy. Please check this Privacy Policy regularly to ensure that you are aware of any changes. We may try to notify you of material changes to this Privacy Policy, which if we do so may be by means such as by posting a notice directly on the Services, by sending an e-mail notification (if you have provided your e-mail address to us), or by other reasonable methods. In any event, if you use the Services after changes to this Privacy Policy, you have accepted the changes. If you do not agree with the changes, please stop using the Services.17. Contact Information :If you have any questions or concerns related to this Privacy Policy, please contact the XFinitive at:5 Lavender Drive, Princeton, NJ 08540
    Info@xFinitive.com
    ...
    Pursuant to applicable law, XFinitive may be required to send you notice of known or suspected security breaches that impact your Personal Information. In the event that XFinitive must provide a notice of a security breach to you, XFinitive will send security breach notices to the contact information contained in your account information unless XFinitive is required by law to notify you using another method. Otherwise, if XFinitive needs, or is required, to contact you concerning any event that involves information about you we may do so by e-mail, telephone, or mail.
    ...
    Through a user’s interactions with our Services, XFinitive collects information that identifies, relates to, describes, is reasonably capable of being associated with, or could reasonably be linked, directly or indirectly, with a particular consumer or household (“CCPA/CPRA Personal Information”).
    ...
    Read More about XFinitive’s Collection of CCPA/CPRA Personal Information
    
    Categories of CCPA/CPRA Personal Information that XFinitive Collects
    ...
    Biometric information If you have biometric authentication integration as part of XFinitive’s Services, then we may collect information concerning your fingerprints, faceprints, voiceprints, and iris or retina scans.
    ...
    Inferences drawn from any of the information identified in this table to create a profile about a consumer reflecting the consumer’s preferences, characteristics, psychological trends, predispositions, behavior, attitudes, intelligence, abilities, and aptitudes Profile reflecting a person’s preferences, characteristics, psychological trends, predispositions, behavior, attitudes, intelligence, abilities, and aptitudes.Sensitive personal information Driver’s license or state identification number; account passwords.Other Information you provide us regarding your attending a XFinitive event; customer information regarding products and services; testimonials; other information as described in this Privacy Policy.
    ...
    Other third parties that interact with us in connection with the services we perform Medical providers, third-party payors, and government authorities Data brokers or resellers from which we purchase data to supplement the information we collect Employees and prospective employees
    Other vendors/suppliers
    Business or Commercial Purpose for Collecting CCPA/CPRA Personal Information
    
    XFinitive uses the CCPA/CPRA Personal Information collected in an effort to improve your experience with the Services, to provide the Services to you and to communicate with you about information that you request. XFinitive may also use CCPA/CPRA Personal Information to help target specific offers to you and to help XFinitive develop and improve its Services. Additionally, XFinitive may use Your CCPA/CPRA Personal Information for one or more of the following business or commercial purposes:
    ...
    As necessary and appropriate to protect the rights, property or safety of XFinitive, our customers or others
    ...
    XFinitive does not sell or share CCPA/CPRA Personal Information as the terms “sell” or “share” are defined by the CCPA. We may also use advertising technologies, such as those described in the Targeted/Advertising Cookies Section 6.1.2.3 and Advertising and Third-Party Data Collection Section 8 of this Privacy Policy, and we will comply with applicable law, including the CCPA/CPRA, as to such activity. To exercise the right to opt-out of the sale or sharing of your CCPA/CPRA Personal Information, you (or your authorized representative) may submit a request to us by visiting the “Your Privacy Choices” section of our website.
    XFinitive has no actual knowledge that it sells CCPA/CPRA Personal Information of consumers under 16 years of age to non-service provider third parties. Additionally, XFinitive has no actual knowledge that it shares CCPA/CPRA Personal Information of consumers under 16 years of age to non-service provider third parties.Read More about XFinitive’s “Sharing” of CCPA/CPRA Personal Information
    
    Categories of CCPA/CPRA Personal Information Shared Categories of Third Parties to Whom CCPA/CPRA Personal Information is SharedIdentifiers Advertising and marketing partnersInternet and other similar network activity Advertising and marketing partners.Purpose for Sharing CCPA/CPRA Personal Information.To market and communicate about our products, services, events, and other offerings.18.3 Disclosure of CCPA/CPRA Personal Information :To facilitate the provision of Services to you and to comply with applicable law, we may disclose Your CCPA/CPRA Personal Information to third parties such as our affiliates; our service providers; other medical providers, third party payors, or clearinghouses; patients; government authorities; third parties for providing the services for which you have contracted; third parties to whom you or your agents authorize us to disclose your CCPA/CPRA Personal Information or to which we must provide your CCPA/CPRA Personal Information to provide services to you; and third parties to comply with applicable law, such as law enforcement.Read More about XFinitive’s Disclosure of CCPA/CPRA Personal InformationScenarios in which we disclose CCPA/CPRA Personal Information include:Categories of CCPA/CPRA Personal Information Disclosed to Third Parties Third Parties to Whom CCPA/CPRA Personal Information is DisclosedbIdentifiers Service Providers; Affiliates; Third parties for providing the services for which you have contracted; Third parties to whom you or your agents authorize us to disclose; Other medical providers, third party payors or clearinghouses; Patients Categories described in Civ. Code § 1798.80(e) Service Providers; Affiliates; Third parties for providing the services for which you have contracted; Third parties to whom you or your agents authorize us to disclose; Other medical providers, third party payors or clearinghouses Characteristics of protected classifications under California or federal law Service Providers; Affiliates; Third parties to whom you or your agents authorize us to discloseBiometric information Service ProvidersInternet or other electronic network activity information Service Providers; Affiliates; Third parties to whom you or your agents authorize us to discloseGeolocation data Service Providers; Affiliates; Third parties to whom you or your agents authorize us to discloseAudio, electronic, visual, thermal, olfactory, or similar information Service Providers; AffiliatesProfessional or employment-related information Service Providers; Affiliates; Third parties to whom you or your agents authorize us to discloseEducation information Service Providers; Affiliates; Third parties to whom you or your agents authorize us to discloseSensitive personal information Service Providers; Affiliates; Third parties to whom you or your agents authorize us to discloseBusiness or Commercial Purpose for Disclosing CCPA/CPRA Personal InformationTo provide, support, personalize, and develop our products, services, events, and other offeringsTo provide service to our customers, which include ProvidersTo market and communicate about our products, services, events, and other offeringsTo process payments, administer fees, provide users with invoices, or resolve billing issuesTo conduct diligence regarding our vendors and partners and administer vendor/partner relationships18.4 CCPA/CPRA Notice at Collection for Online Sources :The CCPA/CPRA requires us to provide certain disclosures at or before our collection of CCPA/CPRA Personal Information from California residents. The below CCPA/CPRA Notice at Collection for Online Sources provides you with information about how we collect and use, sell or share and retain your CCPA/CPRA Personal Information in the online context. When you use or interact with our Services online, including when you communicate with XFinitive by e-mail or online chat window, complete or submit forms to us on our Sites or Provider Portals, or when you visit our Sites or interact with us on social media, we may collect and use the following categories of information.
    Category of CCPA/CPRA Personal Information Purpose for Collection and Use Is the information sold or shared? Criteria Used to Determine Retention PeriodsIdentifiers
    Market and communicate about our products, services, events, and other offerings
    Administer user accounts
    Conduct diligence regarding our vendors and partners and administer vendor/partner relationships
    ...
    Provide, support, personalize, and develop our products, services, events, and other offerings
    Provide service to our customers, which include Providers
    Yes, to Market and communicate about our products, services, events, and other offerings. As necessary to fulfill the specified purposes for collection and use (or a reasonable time thereafter) or other compatible purposes including satisfying legal requirements.Categories described in Civ. Code § 1798.80(e)Market and communicate about our products, services, events, and other offerings
    ...
    Yes,to Market and communicate about our products, services, events, and other offerings. As necessary to fulfill the specified purposes for collection and use (or a reasonable time thereafter) or other compatible purposes including satisfying legal requirements.Internet or other similar network activityMarket and communicate about our products, services, events, and other offerings
    
    Conduct research and analysis
    
    Yes, to Market and communicate about our products, services, events, and other offerings. As necessary to fulfill the specified purposes for collection and use (or a reasonable time thereafter) or other compatible purposes including satisfying legal requirements.Professional or employment-related information Administer user accounts
    ...
    Yes, to Market and communicate about our products, services, events, and other offerings. As necessary to fulfill the specified purposes for collection and use (or a reasonable time thereafter) or other compatible purposes including satisfying legal requirements.Audio, electronic, visual, thermal, olfactory, or similar information Market and communicate about our products, services, events, and other offering No As necessary to fulfill the specified purposes for collection and use (or a reasonable time thereafter) or other compatible purposes including satisfying legal requirements.CCPA/CPRA Sensitive Personal Information from Online Sources
    
    XFinitive may collect sensitive personal information from certain online sources, including password information in the course of users accessing our registration system, and driver’s license and state identification numbers in some instances.18.5 CCPA/CPRA Consumer Rights :
    ...
    The right to delete CCPA/CPRA Personal Information that we collect from you, subject to certain exceptions;The right to correct inaccurate CCPA/CPRA Personal Information that we maintain about you;The right to opt-out of the sale or sharing of CCPA/CPRA Personal Information;The right to opt-out of certain uses of CCPA/CPRA Sensitive Personal Information; andThe right not to be retaliated or discriminated against for exercising any CCPA/CPRA rights in good faith.XFinitive will not discriminate against you for exercising any of the abovementioned rights, for example, by charging a different price or denying goods or services. However, XFinitive may charge a different price or rate or provide a different level or quality of goods or services when that difference is reasonably related to the value provided to us by the data.
    You may also limit the use and disclosure of your CCPA/CPRA Personal Information by either unsubscribing from marketing communications or contacting XFinitive at the address listed above under Section 17 titled “Contact Information.” Please note that some information, excluding claims data information provided by CMS as part of the “Blue Button” program, may remain in XFinitive’s records even after you request deletion of your CCPA/CPRA Personal Information, to the extent required by applicable laws. Additionally, there may be limits to the amount of information XFinitive can practically provide. For example, we may limit access to CCPA/CPRA Personal Information where the burden or expense of providing access would be disproportionate to the risks to an individual’s privacy or where doing so would violate others’ rights.
    18.5.1 Right to Opt Out of the Sale or Sharing of Personal Information :
    As noted above, you have the right to opt out of the sale or sharing of your CCPA/CPRA Personal Information to third parties. To exercise this right, you can visit the “Your Privacy Choices” section of our website. Additionally, XFinitive processes opt-out preference signals in a frictionless manner communicated through Global Privacy Control settings you may turn on in certain browsers through its vendor, OneTrust.18.5.2 Right to Limit Certain Uses of Sensitive Personal Information :
    You also have the right to limit the use or disclosure of your CCPA/CPRA Sensitive Personal Information if used to infer characteristics about you. To exercise this right, please visit the “Your Privacy Choices” section of our website. XFinitive may continue using Sensitive Personal Information for certain purposes expressly permitted by the CCPA/CPRA.18.5.3 How to Exercise All Consumer Rights :
    If you wish to exercise any of these rights, please complete the CCPA/CPRA Consumer Rights Request Form. You may also call us toll-free at +1 (866) 888-6929.We will review your requests and respond accordingly. The rights described herein are not absolute and we reserve all our rights available to us at law in this regard. Additionally, if we retain your CCPA/CPRA Personal Information only in de-identified form, we will not attempt to re-identify your data in response to a Consumer Rights request.
    If you make a request related to CCPA/CPRA Personal Information about you, you will be required to supply a valid means of identification as a security precaution. We will verify your identity with a reasonably high degree of certainty using the following procedure where feasible: we will match identifying information you provide when making the request to the CCPA/CPRA Personal Information maintained by XFinitive or use a third-party identity verification service. If it is necessary to collect additional information, XFinitive will use the information only for verification purposes and will delete it as soon as practicable after complying the request. For requests related to particularly sensitive information, we may require additional proof of identification.
    If you make a Consumer Rights request through an authorized agent, we will require written proof that the agent is authorized to act on your behalf.We will process your request within the time provided by applicable law.18.6 Other California Privacy Rights – Shine a Light :
    In addition to the rights already described, California’s Shine the Light law permits California residents to request certain details about how their information is shared with third parties and, in some cases, affiliates, for those third parties’ and affiliates’ own direct marketing purposes. Under the law, a business must either provide this information or permit California customers to opt in to, or opt out of, this type of sharing.We may from time to time elect to share certain information about you collected by us through the Services with third parties or affiliates for those third parties’ or affiliates’ own direct marketing purposes. If you are a California resident, you may opt out of such future sharing of your personal information (as defined by the California Shine the Light law) by contacting us at info@xFinitive.com  with the phrase “Do Not Share” in the subject line.18.7 XFinitive as Service Provider :
    If you are a California resident and we, as a service provider, have processed personal information about you on behalf of our customers and you wish to exercise your CCPA/CPRA rights, please inquire with our customer directly. If you wish to make your request directly to us, please provide the name of our customer on whose behalf we processed your personal information. We will refer your request to that customer and will support them to the extent required by California privacy law in responding to your request.18.8 Individuals with Disabilities :
    If you have a disability and would like to access this Notice in a different format, you may contact us at info@xFinitive.com with the phrase “Alternative Format California Privacy Notice” in the subject line.18.9 CCPA/CPRA Governing Law :
